...
const signageTypes: SignageType[] = [
  ...
  { quantity: 12, title: 'Panneaux directionnels axes', description: 'Fléchage « The Mall → » sur 3 axes principaux. Éclairage solaire nocturne.', localisation: 'Bd Latrille (×4), Bd Mitterrand (×4), Carrefours Angré (×4)', specs: '4×3m · Vinyle HD · Éclairage solaire · Résistant UV', color: '#34d399' },
  ...
  { quantity: 8, title: 'Plans du centre rétro-éclairés', description: 'Plan général 3 niveaux avec position « Vous êtes ici ». Mise à jour semestrielle enseignes.', localisation: 'Entrées principales (×2) · Jonctions galeries (×4) · Ascenseurs (×2)', specs: '120×80cm · Plexiglas rétro-éclairé · Impression UV · FR/EN', color: '#a77d4c' },
  ...
  { quantity: 1, title: 'Bâche façade pré-ouverture', description: '« The Mall — Un monde à part — Ouverture Octobre 2026 ». Visible depuis Bd Latrille à 300m.', localisation: 'Façade principale boulevard Latrille', specs: '600m² · Impression HD 720 dpi · Vinyle résistant UV 6 mois · Œillets inox', color: '#f59e0b' },
]
