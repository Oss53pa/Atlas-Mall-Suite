    ...
    <div className="space-y-5">
      <div>
        ...
        <input
          ...
          placeholder="The Mall Shopping Center"
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <div className="text-[12px] font-medium text-white">Plan The Mall (démo)</div>
    ...
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: '#080c14' }}>
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          <h1 className="text-[22px] font-bold text-white">Atlas BIM</h1>
