...
// Donnees de reference pour la comparaison du The Mall

export const MALL_BENCHMARKS: MallBenchmark[] = [
  { name: 'The Mall',            city: 'Abidjan',      country: 'CI', surfaceM2: 20000, cameraDensityPer100m2: 0.0,  signageDensityPer100m2: 0.0, evacuationTimeSec: 0, securityScore: 0, parcoursScore: 0, classe: 'B' },
