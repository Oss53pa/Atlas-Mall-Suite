...
export const PROPH3T_CAPABILITIES: Proph3tCapability[] = [
  ...
  },
  {
    ...
    description: 'Forêt aléatoire entraînée sur 50+ malls africains. Prédit le CA prévisionnel d\'un local selon sa surface, catégorie, position, environnement.',
    skill: 'analyzeCommercialMix',
    engine: 'revenueForestEngine',
    normReference: 'Random Forest (Breiman 2001)',
    maturity: 'production',
