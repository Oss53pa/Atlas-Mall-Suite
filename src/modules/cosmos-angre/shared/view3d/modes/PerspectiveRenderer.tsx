...
export default function PerspectiveRenderer({ data, config }: Props) {
  ...
  useEffect(() => {
    ...
    buildThreeScene(containerRef.current, data, { ...config, ssaoEnabled: false, bloomEnabled: false }).then(result => {
