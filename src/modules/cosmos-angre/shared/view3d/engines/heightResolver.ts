...
import type { ZoneHeight } from '../types/view3dTypes'

const DEFAULT_HEIGHTS: Record<string, number> = {
  parking: 3.0, commerce: 4.5, restauration: 4.0, circulation: 5.0,
  technique: 3.0, backoffice: 3.5, financier: 3.5, loisirs: 6.0,
  hotel: 3.2, bureaux: 3.0, exterieur: 0.1, sortie_secours: 4.0, services: 3.5,
}

export function defaultHeightForType(type: string): number {
  return DEFAULT_HEIGHTS[type] ?? 4.0
}
