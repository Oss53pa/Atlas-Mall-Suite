...
export const useContentStore = create<ContentState>()((set) => ({
  ...
  vol2IntroText1: "Le centre commercial Cosmos Angre deploie un dispositif de securite integre couvrant cinq perimetres complementaires : la surveillance perimetrique exterieure, le controle d'acces physique et electronique, un reseau de videosurveillance intelligent de plus de 120 cameras, un systeme de securite incendie conforme ERP categorie 1, et un programme de procedures operationnelles et de formation continue.",
