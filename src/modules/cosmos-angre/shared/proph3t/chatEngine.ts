...
function answerDCERequest(ctx: FullProjectContext): ChatAnswer {
  ...
  let text = `Structure DCE Securite — Cosmos Angre\n\n`
  text += `§1. Objet du marche\n`
  text += `   Fourniture, installation et mise en service du systeme de videoprotection du centre commercial Cosmos Angre (Abidjan, CI).\n\n`
