  ...
  return (
    <div className="flex flex-col h-full bg-gray-950">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {/* Session Info */}
        <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-3 text-xs space-y-1.5">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-purple-400 font-semibold">{onlineUsers.length} en ligne</span>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-1.5">
            {users.map((user) => (
              <div key={user.id} className="flex items-center gap-2.5 px-2 py-1.5 rounded bg-gray-900/50">
                <div
          ...
          <div className="space-y-1">
            {activities.map((act) => (
              <div key={act.id} className="text-[11px] text-gray-400 py-1 border-l-2 border-gray-800 pl-2">
                ...
                <span className="text-purple-400">{act.entity}</span>
