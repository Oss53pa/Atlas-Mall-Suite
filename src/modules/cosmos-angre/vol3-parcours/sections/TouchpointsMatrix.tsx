...
const touchpoints: Touchpoint[] = [
  ...
  { id: 7, name: 'Parfum signature Cosmos', phase: 'Entrée', type: 'physique', responsable: 'Operations', description: 'Diffuseur automatisé, senteur boisée-vanillée exclusive, identité olfactive Cosmos Angré.', priorite: 'secondaire' },
